    ...
    >
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          <h1 className="text-4xl font-bold text-foreground md:text-6xl tracking-tight">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-2-2xl max-auto opacity-0 animate-fade-in-delay-3">
            Driven and detail-oriented Software Developer with a strong
            foundation in both front-end and back-end development, as well as
